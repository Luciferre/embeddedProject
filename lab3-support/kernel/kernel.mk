...
KOBJS := assert.o main.o raise.o IrqStack.o user_mode.o syscalls/read.o syscalls/write.o syscalls/exit.o S_Handler.o C_SWI_Handler.o irqHandler.o irqHandler_c.o timerIrqSetup.o syscalls/time.o syscalls/sleep.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
